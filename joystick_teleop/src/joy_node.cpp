...
int main(int argc, char** argv) {
  ...
  cerr << "command_vel_joy_topic: " << command_vel_joy_topic << endl;
  cerr << "command_button_topic: " << command_button_topic << endl;
  ...
  ros::Publisher cmd_vel_joy_publisher = nh.advertise<geometry_msgs::Twist>(command_vel_joy_topic, 1);
  ros::Publisher button_publisher = nh.advertise<joystick_teleop::msg>(command_button_topic, 1);   
  ros::Rate r(50);
  ...
  while(ros::ok()){
    ...
    cmd_vel_joy_publisher.publish(twist);
